...
class Tree(GardenSec):
    def __init__(self, plant_name: str, plant_height: float,
                 plant_days: int, trunk_diameter: float):
        super().__init__(plant_name, plant_height, plant_days)
...
class Vegetable(GardenSec):
    def __init__(self, plant_name: str, plant_height: float,
                 plant_days: int, harvest_season: str,
                 nutritional_value: float, growth_rate: float,
                 days_passed: int):
        super().__init__(plant_name, plant_height, plant_days)
